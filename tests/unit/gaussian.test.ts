...
const humain = defaultEspece(); // début 18, pic 25, fin 50, pic 40 %, pente 8

describe('Gaussienne de reproduction §9.4 (T014)', () => {
  it('hors de [début, fin] ⇒ probabilité nulle', () => {
    expect(reproProbability(17, humain)).toBe(0);
  ...
  it('aux bornes incluses, la probabilité est > 0', () => {
    expect(reproProbability(18, humain)).toBeGreaterThan(0);
